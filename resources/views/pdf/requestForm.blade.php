...
<h1>Request Form {{ $requestForm->created_at->format('m/d/Y') }} from {{ $requestForm->name }}</h1>
<div>
    <table>
        <thead>
        </thead>
        <tbody>
            ...
            <tr>
                <td class="field-name">Budget Manager</td>
                <td>{{ $requestForm->budgetManager ? $requestForm->budgetManager->name : 'N\A' }}</td>
            </tr>
            <tr>
